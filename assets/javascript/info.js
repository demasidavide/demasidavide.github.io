...
async function getMeteo() {
    try {
        const response = await fetch('https://api.open-meteo.com/v1/forecast?latitude=45.5628&longitude=8.0561&current=temperature_2m,weather_code&timezone=Europe/Rome');
        ...
        // Aggiorna testo
        document.getElementById('meteoInfo').textContent = `Temperatura: ${temp}°C - ${getWeatherDescription(weatherCode)}`;
